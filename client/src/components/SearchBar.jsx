  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center ">
        <div className="flex border-2 border-neutral-900 rounded mb-6">
          <form>
            <input
              onChange={(e) => {
                handleSearch(e);
              ...
              value={query}
              type="text"
              className="px-6 py-4 w-80 placeholder-neutral-900 bg-transparent "
          ...
          <button
            ...
            className="px-4 text-white bg-neutral-900 border-l "
          >
            Go !
          </button>
        </div>
