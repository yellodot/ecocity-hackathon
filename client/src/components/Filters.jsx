...
function Filters() {
  ...
  const isDataSelected = (city, selectedItems, itemKey) => {
    ...
    return (
      ...
      selectedItems.includes(city[itemKey].toLowerCase())
    );
  };
          ...
          <li className="cursor-pointer flex flex-col mr-4 py-2 px-4 mx-auto w-full items-center justify-center bg-transparent underline">
            <div>
              <select
                ...
                value={filterTrees}
                className="focus:outline-none cursor-pointer py-2 px-3 underline text-xl font-medium bg-transparent"
                name="trees"
              >
                <option value="">Espaces verts</option>
                <option value="peu">Peu boisé</option>
                <option value="beaucoup">Très boisé</option>
              </select>
            </div>
          </li>
          <li className="cursor-pointer flex flex-col mr-4 py-2 px-4 mx-auto w-full items-center justify-center bg-transparent underline">
            <div>
              <select
                ...
                name="habitants"
              >
                <option value="">Nombre d'habitants</option>
                <option value="inf-100">Moins de 100000</option>
                <option value="100-300">Entre 100000 et 300000</option>
                <option value="plus-300">Plus de 300000</option>
              </select>
            </div>
          </li>
          <li className="cursor-pointer flex flex-col mr-4 py-2 px-4 mx-auto w-full items-center justify-center bg-transparent underline">
            <div>
              <select
                ...
                name="air"
              >
                <option value="">Qualité de l'air</option>
          ...
          <li className="cursor-pointer flex flex-col mr-4 py-2 px-4 mx-auto w-full items-center justify-center bg-transparent underline">
            <div>
              <select
                ...
                name="velo"
              >
                <option value="">Pistes cyclables</option>
                <option value="peu">Peu d'aménagements</option>
                <option value="beaucoup">Beaucoup d'aménagements</option>
              </select>
            </div>
          </li>
          <li className="cursor-pointer flex flex-col mr-4 py-2 px-4 mx-auto w-full items-center justify-center bg-transparent underline">
            <div>
              <select
                ...
                name="label"
              >
                <option value="">Label Ville Verte</option>
                <option value="vert">Ville écologique</option>
                <option value="orange">En cours de transition</option>
                <option value="rouge">Pas de label</option>
              </select>
            </div>
          </li>
        </ul>
            ...
            {filteredCities?.map((city) => (
              <li className="pb-6">
                <CityCard
                  ...
                  nom={city.nom}
                  score={
                    city.label.toLowerCase() === "vert"
                      ? "80"
                      : city.label.toLowerCase() === "orange"
                      ? "60"
                      : "40"
                  }
                  dechets={city.traitement_dechet}
                  espace={city.espace_vert}
                  qualite={city.qualite_eau}
                />
              </li>
            ))}
          </ul>
